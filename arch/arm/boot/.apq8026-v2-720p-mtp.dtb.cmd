cmd_arch/arm/boot/apq8026-v2-720p-mtp.dtb := /home/dankmemes/android/Synthetic-Kernel/scripts/dtc/dtc -O dtb -o arch/arm/boot/apq8026-v2-720p-mtp.dtb -b 0  -d arch/arm/boot/.apq8026-v2-720p-mtp.dtb.d arch/arm/boot/dts/apq8026-v2-720p-mtp.dts

source_arch/arm/boot/apq8026-v2-720p-mtp.dtb := arch/arm/boot/dts/apq8026-v2-720p-mtp.dts

deps_arch/arm/boot/apq8026-v2-720p-mtp.dtb := \
...
arch/arm/boot/apq8026-v2-720p-mtp.dtb: $(deps_arch/arm/boot/apq8026-v2-720p-mtp.dtb)
