cmd_arch/arm/boot/apq8026-v2-720p-cdp.dtb := /home/dankmemes/android/Synthetic-Kernel/scripts/dtc/dtc -O dtb -o arch/arm/boot/apq8026-v2-720p-cdp.dtb -b 0  -d arch/arm/boot/.apq8026-v2-720p-cdp.dtb.d arch/arm/boot/dts/apq8026-v2-720p-cdp.dts

source_arch/arm/boot/apq8026-v2-720p-cdp.dtb := arch/arm/boot/dts/apq8026-v2-720p-cdp.dts

deps_arch/arm/boot/apq8026-v2-720p-cdp.dtb := \
  arch/arm/boot/dts/apq8026-v2.dtsi \
  ...
  arch/arm/boot/dts/msm8226-720p-cdp.dtsi \
  arch/arm/boot/dts/msm8226-camera-sensor-cdp.dtsi \

arch/arm/boot/apq8026-v2-720p-cdp.dtb: $(deps_arch/arm/boot/apq8026-v2-720p-cdp.dtb)
